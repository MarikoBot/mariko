...
exports.Monitoring = exports.panelButtons = exports.mainEmbed = void 0;
...
exports.panelButtons = [
    new discord_js_1.ButtonBuilder().setEmoji(Emojis_1.default.lightRefresh).setCustomId('monitoring_refresh').setStyle(v10_1.ButtonStyle['Primary']),
    new discord_js_1.ButtonBuilder().setEmoji(Emojis_1.default.lightPing).setCustomId('monitoring_ping').setStyle(v10_1.ButtonStyle['Primary']),
];
/**
...
class Monitoring {
    ...
    async refreshChannel() {
        ...
        const payload = {
            ...
            components: (0, index_1.generatePanelRows)(exports.panelButtons),
        };
        if (!messages.first())
